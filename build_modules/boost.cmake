...
if(Boost_FOUND)   
  ...
  execute_process(COMMAND ./b2 -j${N} --toolset=${Boost_BUILD_TOOLSET} --with-system --with-thread --with-date_time --with-filesystem --with-regex WORKING_DIRECTORY ${BOOST_ROOT})
