...
if(Boost_FOUND)   
  ...
  if (NOT EXISTS "${BOOST_ROOT}/b2.exe")
    ...
    if(UNIX) 
      execute_process(COMMAND bootstrap.sh WORKING_DIRECTORY "./boost_1_59_0")
    endif()

    if(WIN32)
      message("Building Boost.Build")
      set(CMD1 "%VS140COMNTOOLS%vsvars32.bat")
      set(CMD2 "bootstrap.bat")
      set(CMD3 "${CMD1} & ${CMD2}")
      execute_process(COMMAND "${CMAKE_SOURCE_DIR}/build.bat")   
    endif()
  else()
